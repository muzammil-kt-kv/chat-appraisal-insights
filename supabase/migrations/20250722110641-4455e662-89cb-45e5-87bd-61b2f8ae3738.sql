...
-- Also update the appraisal_status enum to match what we need
ALTER TYPE public.appraisal_status DROP VALUE IF EXISTS 'team_lead_approved';
ALTER TYPE public.appraisal_status DROP VALUE IF EXISTS 'ai_analyzed';
